...
//@EnableFeignClients("com.gymnasticbodies.microservices.currencyconversionservice")
...
//    }
    ...
    public Docket api() throws IOException, XmlPullParserException {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gymnasticbodies.microservices.currencyconversionservice"))
